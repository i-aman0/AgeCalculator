        ...
        val dpd = DatePickerDialog(this,{ _, selectedYear, selectedMonth, selectedDayOfMonth ->
            ...
            theDate?.let {
                ...
                currentDate?.let {
                    ...
                    var year: Long = differenceInMinutes / 525600
                    val remainingMinutes: Long = differenceInMinutes % 525600
                    val day = remainingMinutes / 1440

                    var txt="$year years and $day days"

                    tvSelectedDateInMinutes.text = txt.toString()
                }
            }
        },
            year,month,day)
